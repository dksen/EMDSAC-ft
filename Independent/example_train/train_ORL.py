...
from training.trainer import create_trainer,create_offlinetrainer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--datasets", type=str, default="walker2d-medium-replay-v2", help="id of dataset")
    ...
    parser.add_argument("--algorithm", type=str, default="EMDSAC", help="DSAC_V2 or DSAC_V1")
    ...
    parser.add_argument("--num_q_networks", type=int, default=5)
  ...
  ################################################
    ...
    trainer = create_offlinetrainer(dataset, alg, sampler, buffer, evaluator, **args)
